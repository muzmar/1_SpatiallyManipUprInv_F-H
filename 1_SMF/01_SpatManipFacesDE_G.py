...
try:
    for i in range(23):
        num = str(i+1)
        image_name = "Sim_match_of_spec_man_F_2_0" + num
        instructions.append(Image(image_name).buffer())

    instructions.append(Image("Sim_match_of_spec_man_F_2_024").buffer(factor=1.33))
    instructions.append(Image("Sim_match_of_spec_man_F_2_025").buffer())
