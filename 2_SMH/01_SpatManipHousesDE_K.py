...
try:
    for i in range(31):
        num = str(i+1)
        image_name = "Sim_match_of_spec_man_H_1_0" + num
        instructions.append(Image(image_name).buffer())

    instructions.append(Image("Sim_match_of_spec_man_H_1_032").buffer(factor=1.33))
    instructions.append(Image("Sim_match_of_spec_man_H_1_033").buffer())
